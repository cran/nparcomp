...
function(formula, data , type = c("Tukey", "Dunnett",
    ...
    "Marcus", "UmbrellaWilliams", "UserDefined"),conf.level=0.95, alternative = c("two.sided", "less", "greater"),
    asy.method = c("fisher", "mult.t", "normal"), plot.simci=FALSE, control=NULL, info = TRUE,
